...
var __PRIVATE_OrderedCodeWriter = class {
  ...
  qt(e) {
    for (const t of e) {
      const e2 = t.charCodeAt(0);
      if (e2 < 128) this.Lt(e2);
      else if (e2 < 2048) this.Lt(960 | e2 >>> 6), this.Lt(128 | 63 & e2);
      else if (t < "\uD800" || "\uDBFF" < t) this.Lt(480 | e2 >>> 12), this.Lt(128 | 63 & e2 >>> 6), this.Lt(128 | 63 & e2);
      else {
        const e3 = t.codePointAt(0);
        this.Lt(240 | e3 >>> 18), this.Lt(128 | 63 & e3 >>> 12), this.Lt(128 | 63 & e3 >>> 6), this.Lt(128 | 63 & e3);
      }
    }
    this.Bt();
  }
...
var __PRIVATE_IndexedDbIndexManager = class {
      ...
      if (r) {
        ...
        return PersistencePromise.forEach(i, (i2, s) => {
          ...
          const o = function __PRIVATE_targetGetArrayValues(e3, t2) {
            ...
            return new Bound(n2, r3);
          }(s, i2), c = this.En(i2, s, a), l = this.En(i2, s, u), h = this.dn(i2, s, _), P = this.An(i2.indexId, o, c, a.inclusive, l, u.inclusive, h);
  ...
  fn(e, t) {
    ...
    for (const r of __PRIVATE_fieldIndexGetDirectionalSegments(e)) {
      ...
      const i = n.Xt(r.kind);
      __PRIVATE_FirestoreIndexValueWriter.Ft.Et(e2, i);
    }
    return n.Ht();
  }
  ...
  Rn(e) {
    ...
    return __PRIVATE_FirestoreIndexValueWriter.Ft.Et(e, t.Xt(
      0
      /* IndexKind.ASCENDING */
    )), t.Ht();
  }
  ...
  gn(e, t) {
    const n = new __PRIVATE_IndexByteEncoder();
    return __PRIVATE_FirestoreIndexValueWriter.Ft.Et(__PRIVATE_refValue(this.databaseId, t), n.Xt(function __PRIVATE_fieldIndexGetKeyOrder(e2) {
  ...
  dn(e, t, n) {
    ...
    for (const s of __PRIVATE_fieldIndexGetDirectionalSegments(e)) {
      ...
      for (const n2 of r) if (this.pn(t, s.fieldPath) && isArray(e2)) r = this.yn(r, s, e2);
        ...
        __PRIVATE_FirestoreIndexValueWriter.Ft.Et(e2, t2);
      }
    }
    return this.wn(r);
  }
  ...
  yn(e, t, n) {
    ...
    for (const e2 of n.arrayValue.values || []) for (const n2 of r) {
      ...
      r2.seed(n2.Ht()), __PRIVATE_FirestoreIndexValueWriter.Ft.Et(e2, r2.Xt(t.kind)), i.push(r2);
    }
    return i;
  }
  pn(e, t) {
...
var __PRIVATE_MemoryDocumentOverlayCache = class {
  constructor() {
    this.overlays = new SortedMap(DocumentKey.comparator), this.Er = /* @__PURE__ */ new Map();
  }
  getOverlay(e, t) {
...
var __PRIVATE_IndexedDbPersistence = class ___PRIVATE_IndexedDbPersistence {
  constructor(e, t, n, r, i, s, o, _, a, u, c = 17) {
    ...
    this.Ei = null, /** The client metadata refresh task. */
    this.di = null, /** The last time we garbage collected the client metadata object store. */
   ...
   */
  wi() {
    this.di = this.li.enqueueAfterDelay("client_metadata_refresh", 4e3, () => this.gi().then(() => this.xi()).then(() => this.wi()));
  }
  ...
  async shutdown() {
    this.Ur = false, this.ki(), this.di && (this.di.cancel(), this.di = null), this.qi(), this.Qi(), // Use `SimpleDb.runTransaction` directly to avoid failing if another tab
   ...
   */
  Ni(e, t) {
    return e.filter((e2) => this.Oi(e2.updateTimeMs, t) && !this.Bi(e2.clientId));
  }
  /**
  ...
  Ui(e) {
    return __PRIVATE_primaryClientStore(e).get("owner").next((e2) => {
      if (null !== e2 && this.Oi(e2.leaseTimestampMs, 5e3) && !this.Bi(e2.ownerId) && !this.Fi(e2) && !(this.Pi || this.allowTabSynchronization && e2.allowTabSynchronization)) throw new FirestoreError(D.FAILED_PRECONDITION, Ve);
    });
  }
  /**
...
async function __PRIVATE_localStoreApplyBundledDocuments(e, t, n, r) {
  ...
  return i.persistence.runTransaction("Apply bundle documents", "readwrite", (e2) => __PRIVATE_populateDocumentChangeBuffer(e2, _, o).next((t2) => (_.apply(e2), t2)).next((t2) => i.Gr.removeMatchingKeysForTargetId(e2, a.targetId).next(() => i.Gr.addMatchingKeys(e2, s, a.targetId)).next(() => i.localDocuments.getLocalViewOfDocuments(e2, t2.Is, t2.Es)).next(() => t2.Is)));
}
...
var __PRIVATE_WebStorageSharedClientState = class {
  constructor(e, t, n, r, i) {
    ...
    }(this.persistenceKey), this.Ls = function createBundleLoadedKey(e2) {
    ...
    try {
      ...
      async function __PRIVATE_handleTargetError(e2, t2) {
        ...
        for (const r of t2.targetIds)
          e2.B_.has(r) && (await e2.remoteSyncer.rejectListen(r, n2), e2.B_.delete(r), e2.U_.removeTarget(r));
      }(e, t);
    } catch (n2) {
    ...
    */
    function __PRIVATE_raiseWatchSnapshot(e2, t3) {
      ...
      n2.targetMismatches.forEach((t4, n3) => {
        ...
        if (!r)
          return;
        e2.B_.set(t4, r.withResumeToken(ByteString.EMPTY_BYTE_STRING, r.snapshotVersion)), // Cause a hard reset by unwatching and rewatching immediately, but
...
async function __PRIVATE_syncEngineApplyBatchState(e, t, n, r) {
  ...
  null !== s ? ("pending" === n ? (
    ...
    (__PRIVATE_processUserCallback(i, t, r || null), __PRIVATE_triggerPendingWritesCallbacks(i, t), function __PRIVATE_localStoreRemoveCachedMutationBatchMetadata(e2, t2) {
      __PRIVATE_debugCast(__PRIVATE_debugCast(e2).mutationQueue).Ln(t2);
    }(i.localStore, t))
...
async function __PRIVATE_syncEngineApplyPrimaryState(e, t) {
  ...
  if (__PRIVATE_ensureWatchCallbacks(n), __PRIVATE_syncEngineEnsureWriteCallbacks(n), true === t && true !== n.$a) {
    ...
    function __PRIVATE_resetLimboDocuments(e3) {
      ...
      }), t3.ka.wr(), t3.Ba = /* @__PURE__ */ new Map(), t3.La = new SortedMap(DocumentKey.comparator);
  ...
  return e.asyncQueue.enqueueAndForget(async () => async function __PRIVATE_executeQueryFromCache(e2, t2, n2) {
    try {
      const r = await __PRIVATE_localStoreExecuteQuery(
        ...
        /* usePreviousResults= */
        true
      ), i = new __PRIVATE_View(t2, r.ds), s = i.ga(r.documents), o = i.applyChanges(
        s,
        /* limboResolutionEnabled= */
        false
      );
...
!function __PRIVATE_registerFirestore(e, t = true) {
  ...
  }, "PUBLIC").setMultipleInstances(true)), registerVersion(w, "4.7.5", e), // BUILD_TARGET will be replaced by values like esm2017, cjs2017, etc during the compilation
  registerVersion(w, "4.7.5", "esm2017");
}();
export {
