...
const CadastroBackbone = () => {
  ...
  useEffect(() => {
    ...
    const filtered = cidades.filter((cid) =>
      (cid.nome || "").toLowerCase().includes(searchTermCidadeAfetada.toLowerCase())
    );
  ...
  const regionais = [
    "MFA", "JCA", "CTA", "JGS", "JVE", "SOO", "CCO", "SPO", "RJO", "LGS", "PYE",
    "MS", "CSL", "CSC", "PGO", "CDR", "UVA", "VDA", "CNI", "RSL", "IRI", "ITH",
  ];
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const payload = {
        ...
        status: "Requisição",
        total_afetados: 0,
        StatusReal: "Analise Monitoramento", // Valor fixo adicionado
      };

      const protocoloRef = doc(db, "protocolos", backboneData.ispProtocolo);
      await setDoc(protocoloRef, { ...payload, id: protocoloRef.id });
  ...
  return (
    <div className="flex min-h-screen w-full items-center justify-center bg-transparent text-slate-900">
      <div className="w-11/12 max-w-3xl rounded-lg border border-black bg-white p-8 shadow-lg">
        <ToastContainer
          position="top-left"
          autoClose={5000}
        ...
        <h1 className="mb-6 text-center text-2xl font-bold">Cadastro de Requisição</h1>

        <form onSubmit={handleSubmit} className="space-y-6">
          {/* Usuário Solicitante */}
          <div>
            <label className="mb-2 block font-bold">Usuário Solicitante:</label>
            <input
              type="text"
              name="usuarioSolicitante"
              value={backboneData.usuarioSolicitante}
              onChange={(e) =>
                setBackboneData({ ...backboneData, usuarioSolicitante: e.target.value })
              }
              className="w-full rounded border border-gray-300 bg-white p-2 text-slate-900"
          ...
          {/* Gerências/Setor */}
          <div>
            <label className="mb-2 block font-bold">Gerências/Setor:</label>
            <select
              name="gerenciaSetor"
            ...
            >
              ...
              <option value="Comercial Corporativo Sudeste e Operadoras">
                Comercial Corporativo Sudeste e Operadoras
              </option>
              <option value="Comercial Varejo">Comercial Varejo</option>
              <option value="Entregas e Soluções Corporativas">
                Entregas e Soluções Corporativas
              </option>
              <option value="Operações de Campo Corporativo e Backbone">
                Operações de Campo Corporativo e Backbone
              </option>
              ...
              <option value="Transformação Digital e Governança">
          ...
          <div>
            <label className="mb-2 block font-bold">Parceiro swap/Last Mile?</label>
            <Toggle
              checked={backboneData.parceiroSwap}
              onChange={(e) =>
                setBackboneData({ ...backboneData, parceiroSwap: e.target.checked })
              }
              label="Ativar"
            />
          </div>
          ...
          {/* Gerência */}
          <div>
            <label className="mb-2 block font-bold">Gerência:</label>
            <select
              name="gerencia"
          ...
          <div>
            <label className="mb-2 block font-bold">Atividade em Rede de Parceiro?</label>
            <Toggle
              checked={backboneData.atividadeRede}
              onChange={(e) =>
                setBackboneData({ ...backboneData, atividadeRede: e.target.checked })
              }
              label="Ativar"
            />
          </div>
          ...
          {/* Resumo */}
          <div>
            <label className="mb-2 block font-bold">Resumo:</label>
            <textarea
              name="resumo"
              value={backboneData.resumo}
              onChange={(e) =>
                setBackboneData({ ...backboneData, resumo: e.target.value })
              }
          ...
          {/* Classificação */}
          <div>
            <label className="mb-2 block font-bold">Classificação:</label>
            <select
              name="classificacao"
              value={backboneData.classificacao}
              onChange={(e) =>
                setBackboneData({ ...backboneData, classificacao: e.target.value })
              }
              className="w-full rounded border border-gray-300 bg-white p-2 text-slate-900"
            >
              <option value="">Selecione</option>
          ...
          {/* Grupo de Atividade */}
          <div>
            <label className="mb-2 block font-bold">Grupo de Atividade:</label>
            <select
              name="grupoAtividade"
              value={backboneData.grupoAtividade}
              onChange={(e) =>
                setBackboneData({ ...backboneData, grupoAtividade: e.target.value })
              }
              className="w-full rounded border border-gray-300 bg-white p-2 text-slate-900"
            >
              <option value="">Selecione</option>
          ...
          {/* Impacto no Backbone */}
          <div className="mb-6">
            <label className="mb-2 block font-bold">Impacto no Backbone:</label>
            <div className="grid grid-cols-3 gap-4">
              <label className="flex items-center space-x-2">
                <input
                  ...
                  onChange={(e) =>
                    setBackboneData({ ...backboneData, impactoBackbone: e.target.value })
                  }
          ...
          {/* Impacto em Clientes */}
          <div className="mb-6">
            <label className="mb-2 block font-bold">Impacto em Clientes:</label>
            <div className="grid grid-cols-3 gap-4">
              <label className="flex items-center space-x-2">
                <input
                  type="radio"
                  ...
                  onChange={(e) =>
                    setBackboneData({ ...backboneData, impactoClientes: e.target.value })
                  }
                  className="accent-black"
                />
                <span>Interrupção</span>
          ...
          {/* Criticidade */}
          <div className="mb-6">
            <label className="mb-2 block font-bold">Criticidade:</label>
            <div className="grid grid-cols-3 gap-4">
              <label className="flex items-center space-x-2">
                <input
                  type="radio"
                  ...
                  onChange={(e) =>
                    setBackboneData({ ...backboneData, criticidade: e.target.value })
                  }
                  className="accent-black"
                />
                <span>Alta</span>
          ...
          <div>
            <label className="mb-2 block font-bold">Envolve equipamento?</label>
            <Toggle
              checked={backboneData.envolveEquipamento}
              onChange={(e) =>
                setBackboneData({ ...backboneData, envolveEquipamento: e.target.checked })
              }
              label="Ativar"
            />
          </div>
          ...
          {/* Toggle - Envolve DWDM? */}
          <div>
            <label className="mb-2 block font-bold">Envolve DWDM?</label>
            <Toggle
              checked={backboneData.envolveDwdm}
              onChange={(e) =>
                setBackboneData({ ...backboneData, envolveDwdm: e.target.checked })
              }
              label="Ativar"
            />
          </div>
          ...
          {/* Regional */}
          <div>
            <label className="mb-2 block font-bold">Regional:</label>
            <select
              name="regional"
              value={backboneData.regional}
              onChange={(e) =>
                setBackboneData({ ...backboneData, regional: e.target.value })
              }
              className="w-full rounded border border-gray-300 bg-white p-2 text-slate-900"
            >
          ...
          {/* Cidade Afetada */}
          <div>
            <label className="mb-2 block font-bold">Cidade Afetada:</label>
            <div ref={cidadeAfetadaRef} className="relative mb-4 rounded border border-gray-300 p-2">
              <div className="flex flex-wrap gap-1">
                {backboneCidadesAfetadas.map((cidade) => (
                  <div key={cidade.id} className="flex items-center rounded bg-blue-100 px-2 py-1 text-slate-900">
                    <span className="mr-1">
                ...
                <input
                  type="text"
                  className="min-w-[80px] flex-1 bg-transparent text-slate-900 placeholder-gray-500 outline-none"
              ...
              {searchTermCidadeAfetada && citySearchResultsAfetada.length > 0 && (
                <ul className="absolute left-0 top-full z-10 mt-1 max-h-40 w-full overflow-y-auto rounded border bg-white shadow">
          ...
          {/* Data Prevista 1 */}
          <div>
            <label className="mb-2 block font-bold">Data Prevista 1:</label>
            <input
              type="date"
              name="dataPrevista1"
              value={backboneData.dataPrevista1}
              onChange={(e) =>
                setBackboneData({ ...backboneData, dataPrevista1: e.target.value })
              }
              className="w-full rounded border border-gray-300 p-2 text-slate-900"
            />
          </div>
          ...
          {/* Data Prevista 2 */}
          <div>
            <label className="mb-2 block font-bold">Data Prevista 2:</label>
            <input
              type="date"
              name="dataPrevista2"
              value={backboneData.dataPrevista2}
              onChange={(e) =>
                setBackboneData({ ...backboneData, dataPrevista2: e.target.value })
              }
              className="w-full rounded border border-gray-300 p-2 text-slate-900"
            />
          </div>
          ...
          {/* Hora Início */}
          <div>
            <label className="mb-2 block font-bold">Hora Início:</label>
            <input
              type="time"
              name="horaInicio"
              value={backboneData.horaInicio}
              onChange={(e) =>
                setBackboneData({ ...backboneData, horaInicio: e.target.value })
              }
              className="w-full rounded border border-gray-300 p-2 text-slate-900"
            />
          </div>
          ...
          {/* Hora Fim */}
          <div>
            <label className="mb-2 block font-bold">Hora Fim:</label>
            <input
              type="time"
              name="horaFim"
              value={backboneData.horaFim}
              onChange={(e) =>
                setBackboneData({ ...backboneData, horaFim: e.target.value })
              }
              className="w-full rounded border border-gray-300 p-2 text-slate-900"
            />
          </div>
          ...
          {/* ISP Protocolo */}
          <div>
            <label className="mb-2 block font-bold">ISP Protocolo:</label>
            <input
              type="text"
              name="ispProtocolo"
          ...
          {/* Justificação */}
          <div>
            <label className="mb-2 block font-bold">Justificação:</label>
            <textarea
              name="justificacao"
              value={backboneData.justificacao}
              onChange={(e) =>
                setBackboneData({ ...backboneData, justificacao: e.target.value })
              }
              className="w-full rounded border border-gray-300 p-2 text-slate-900"
              rows="3"
          ...
          {/* Descrição */}
          <div>
            <label className="mb-2 block font-bold">Descrição:</label>
            <textarea
              name="descricao"
              value={backboneData.descricao}
              onChange={(e) =>
                setBackboneData({ ...backboneData, descricao: e.target.value })
              }
              className="w-full rounded border border-gray-300 p-2 text-slate-900"
              rows="4"
          ...
          <button
            ...
            className="block w-full rounded bg-blue-500 p-3 text-white hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50"
          >
            {isSubmitting ? (
